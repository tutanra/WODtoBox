...
4. `#/plan/.../train` — sesión: marcar series, ajustar reps hechas. Misma columna y padding que el resto de pantallas. La pausa arranca al marcar una serie (si no es la última) y suena el mismo pitido de inicio que el timer; el recuadro (PAUSA, reloj, **Saltar**) se superpone arriba sin mover el listado ni mostrar chips. En los últimos 10 s pulsa como el timer. Si no está activa, no ocupa sitio. Chips de pausa 2:00 / 2:30 / 3:00 y **otro** (tiempo a medida) van en el listado. Cada serie marcada o desmarcada actualiza el historial; si no queda ninguna, el día desaparece de ahí. Atrás sale de la sesión. En el programa: **Reiniciar plan** borra el progreso de las sesiones; **Borrar plan** quita el programa. El historial de días con series hechas se queda.
